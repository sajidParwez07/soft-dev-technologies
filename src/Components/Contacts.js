        ...
        <section id="contact" className="contact">
            <div className="container" data-aos="fade-up">
                ...
                <div className="section-title">
                    <h2>Contact</h2>
                    <p>
                        Thank you for your interest in Soft Dev Technologies. We value your inquiries
                        and feedback. Please feel free to reach out to us using the contact
                        information below.
                    </p>
                </div>
                    ...
                    <div className="col-lg-5 d-flex align-items-stretch">
                        <div className="info">
                            <div className="address">
                                ...
                                <h4>Location:</h4>
                                <p>At sanjay nagar, Marathahalli, Bangalore</p>
                            </div>

                            <div className="email">
                                <i className="bi bi-envelope"></i>
                                <h4>Email:</h4>
                                <p>softdevtech@gmail.com</p>
                            </div>
